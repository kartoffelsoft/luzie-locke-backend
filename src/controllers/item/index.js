...
const makeGetItemListByUser = require('./get-item-list-by-user.js')
...
const getItemListByUser     = makeGetItemListByUser({ readItemListByUser: itemUseCases.readItemListByUser })
